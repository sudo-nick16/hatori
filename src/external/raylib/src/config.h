 ...
 *
 *   This file defines all the configuration flags for the different raylib
 *modules
 *
 *   LICENSE: zlib/libpng
 *
...
#define SUPPORT_MODULE_RTEXT                                                   \
	1 // WARNING: It requires SUPPORT_MODULE_RTEXTURES to load sprite font
		// textures
...
//------------------------------------------------------------------------------------
// Camera module is included (rcamera.h) and multiple predefined cameras are
// available: free, 1st/3rd person, orbital
#define SUPPORT_CAMERA_SYSTEM 1
// Gestures module is included (rgestures.h) to support gestures detection: tap,
// hold, swipe, drag
#define SUPPORT_GESTURES_SYSTEM 1
// Include pseudo-random numbers generator (rprand.h), based on Xoshiro128** and
// SplitMix64
#define SUPPORT_RPRAND_GENERATOR 1
// Mouse gestures are directly mapped like touches and processed by gestures
// system
...
// Use busy wait loop for timing sync, if not defined, a high-resolution timer
// is set up and used
...
// Allow automatic screen capture of current screen pressing F12, defined in
// KeyCallback()
#define SUPPORT_SCREEN_CAPTURE 1
// Allow automatic gif recording of current screen pressing CTRL+F12, defined in
// KeyCallback()
#define SUPPORT_GIF_RECORDING 1
// Support CompressData() and DecompressData() functions
#define SUPPORT_COMPRESSION_API 1
// Support automatic generated events, loading and recording of those events
// when required
#define SUPPORT_AUTOMATION_EVENTS 1
// Support custom frame control, only for advanced users
// By default EndDrawing() does this job: draws everything + SwapScreenBuffer()
// + manage frame timing + PollInputEvents() Enabling this flag allows manual
// control of the frame processes, use at your own risk
...
#define MAX_FILEPATH_LENGTH                                                    \
	4096 // Maximum length for filepaths (Linux PATH_MAX default value)
...
#define MAX_GAMEPAD_BUTTONS                                                    \
	32 // Maximum number of buttons supported (per gamepad)
#define MAX_GAMEPAD_VIBRATION_TIME 2.0f // Maximum vibration time in seconds
#define MAX_TOUCH_POINTS 8 // Maximum number of touch points supported
#define MAX_KEY_PRESSED_QUEUE                                                  \
	16 // Maximum number of keys in the key input queue
#define MAX_CHAR_PRESSED_QUEUE                                                 \
	16 // Maximum number of characters in the char input queue

#define MAX_DECOMPRESSION_SIZE 64 // Max size allocated for decompression in MB

#define MAX_AUTOMATION_EVENTS                                                  \
	16384 // Maximum number of automation events to record
...
// #define RL_DEFAULT_BATCH_BUFFER_ELEMENTS    4096    // Default internal
// render batch elements limits
...
// Support procedural image generation functionality (gradient, spot,
// perlin-noise, cellular)
#define SUPPORT_IMAGE_GENERATION 1
// Support multiple image editing functions to scale, adjust colors, flip, draw
// on images, crop... If not defined, still some functions are supported:
// ImageFormat(), ImageCrop(), ImageToPOT()
#define SUPPORT_IMAGE_MANIPULATION 1

//------------------------------------------------------------------------------------
// Module: rtext - Configuration Flags
//------------------------------------------------------------------------------------
// Default font is loaded on window initialization to be available for the user
// to render simple text NOTE: If enabled, uses external module functions to
// load default raylib font
...
// On font atlas image generation [GenImageFontAtlas()], add a 3x3 pixels white
// rectangle at the bottom-right corner of the atlas. It can be useful to for
// shapes drawing, to allow drawing text and shapes with a single draw call
// [SetShapesTexture()].
...
// Support procedural mesh generation functions, uses external par_shapes.h
// library NOTE: Some generated meshes DO NOT include generated texture
// coordinates
